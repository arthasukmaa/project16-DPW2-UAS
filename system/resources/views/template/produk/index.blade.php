                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                          <a href="{{url('admin/produk', $produk->uuid)}}" class="btn btn-primary" ><i  class="fa fa-info" data-feather="info"></i></a>
                          <a href="{{url('admin/produk', $produk->uuid)}}/edit" class="btn btn-warning"><i class="fa fa-edit"data-feather="edit" ></i></a>
